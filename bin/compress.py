...
try:
    ...
    closure_compiler = "bin/closure-compiler-v20180101.jar"
else:
    closure_compiler = closure.get_jar_filename()

js_path = Path(__file__) .parent / 'swing-master-2' / 'src'
...
Compiler library and Java version 6 or later."""
    ...
    if not options.file:
        ...
        files = [
            js_path / f
            for f in ["Card.js", "Direction.js", "index.js", "Stack.js", "utilities.js"]
        ]
    else:
